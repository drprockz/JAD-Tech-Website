						...
						<div className="container position-relative z-2">
							<div className="row py-90">
								<div className="col-lg-4 pe-10" data-aos="fade-zoom-in" data-aos-delay={100}>
									<Link className="navbar-brand d-flex main-logo align-items-center" href="/"><span>JAD Tech</span></Link>
								...
								<div className="col-lg-8">
									<div className="row">
										...
										<div className="col-lg-3 col-md-4 col-6" data-aos="fade-zoom-in" data-aos-delay={400}>
											...
											<div className="d-flex flex-column align-items-start">
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">SEO</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">SMM</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Digital Marketing</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Web Development</Link>
							...
							<div className="row text-center py-4 border-top border-white border-opacity-10">
								<span className="text-white opacity-50" data-aos="fade-zoom-in" data-aos-delay={200}>Copyright © 2024 JAD Tech. All Rights Reserved</span>
							</div>
						</div>
					</div>
